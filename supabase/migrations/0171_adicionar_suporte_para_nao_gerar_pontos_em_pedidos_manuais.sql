-- Adicionar suporte para não gerar pontos de fidelidade em pedidos manuais
-- Quando benefits_used = 'no_loyalty_points', a trigger pula a geração de pontos
...
BEGIN
    -- Se benefits_used = 'no_loyalty_points', pula a geração de pontos
    -- Isso permite que pedidos manuais não gerem pontos de fidelidade se desejado pelo admin
    IF NEW.benefits_used = 'no_loyalty_points' THEN
        RETURN NEW;
    END IF;
