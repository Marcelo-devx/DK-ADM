                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    ...
                    {client.force_pix_on_next_purchase ? (
                      ...
                      <Badge variant="outline" className="text-green-600 bg-green-50 border-green-200 flex gap-1 items-center">
                        <CreditCard className="w-3 h-3" /> Cartão Liberado
                      </Badge>
                    )}
                  </div>
                </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                          ...
                          <div className="bg-white p-3 rounded shadow-sm border border-yellow-100">
                            ...
                            <p className="font-black text-blue-600 flex items-center justify-center gap-1">
                              <History className="w-3 h-3" /> {rawOrders?.length || 0}
                            </p>
                          </div>
                          <div className="bg-white p-3 rounded shadow-sm border border-yellow-100">
                                    ...
                                    <div className="text-sm text-slate-700 bg-white p-3 rounded-lg shadow-sm border min-w-[220px] space-y-1">
                                      ...
                                      {donation > 0 && (
                                        <div className="flex justify-between gap-8 text-rose-600 font-medium">
                                          <span className="text-xs">Doação</span>
                                  ...
                                  {isLoadingItems ? (
                                    ...
                                    <>
                                      <p className="text-xs font-bold text-muted-foreground uppercase flex items-center gap-1">
                                        <Package className="w-3 h-3" /> Itens do Pedido ({items.length})
                                      </p>
                                      <div className="space-y-2">
