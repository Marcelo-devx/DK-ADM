...
import { Package, Home, LayoutGrid, Cloud, Image, Tags, Settings, Percent, MessageSquare, Users, ListTree, GalleryHorizontal, Star, Ticket, Plug, ShoppingCart, DollarSign, Truck, Coins, Printer, Map as MapIcon, Lock, FileOutput, FileUp, Workflow, BarChart3 } from "lucide-react";
    ...
    <aside className="w-64 h-screen bg-gray-100 p-4 flex flex-col">
      ...
      <nav className="flex flex-col space-y-2 overflow-y-auto flex-1 text-sm">
        ...
        <NavLink to="/dashboard/spoke-export" className={navLinkClass}>
          <FileOutput className="w-4 h-4 mr-3 text-blue-600" />
          Exportar Rotas
        </NavLink>
        ...
        <NavLink to="/dashboard/import-clients" className={navLinkClass}>
          <FileUp className="w-4 h-4 mr-3 text-green-600" />
          Importar Clientes
        </NavLink>
